...
NMA.1yr.res <- run_NMA(NMA.1yr,"BCVA ETDRS NMA 1 year")
...
NMA.2yr.res <- run_NMA(NMA.2yr,"BCVA ETDRS NMA 1-2 years")
...
NMA.maxFU.res <- run_NMA(NMA.maxFU,"BCVA ETDRS NMA max FU")
...
NMA.reduced.res <- run_NMA(NMA.reduced,"BCVA ETDRS NMA by drug")
...
NMA.class.res <- run_NMA(NMA.class,"BCVA ETDRS NMA by class")
